    ...
    <section id="contact" className="py-20 px-4">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-serif font-bold text-3xl md:text-4xl text-balance mb-6">Vamos Conversar?</h2>
          <p className="text-lg text-muted-foreground text-pretty mb-12 max-w-2xl mx-auto">
            Interessado em conhecer mais sobre o NúcleoDrop? Entre em contato e descubra como podemos transformar a
            gestão da sua radiofarmácia.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-4">Conversa rápida e direta</p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-4">Contato profissional</p>
                <Button variant="outline" size="sm" className="w-full bg-transparent" asChild>
                  <a href="mailto:contato@nucleodrop.com.br">Enviar</a>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-4">Rede profissional</p>
                <Button variant="outline" size="sm" className="w-full bg-transparent" asChild>
                  <a href="https://linkedin.com/in/nucleodrop" target="_blank" rel="noopener noreferrer">
                    Conectar
                  </a>
                </Button>
              </CardContent>
          ...
          <div className="bg-gradient-to-r from-secondary/10 to-primary/10 rounded-2xl p-8 border border-secondary/20">
            <h3 className="font-serif font-semibold text-2xl mb-4">Pronto para Inovar?</h3>
